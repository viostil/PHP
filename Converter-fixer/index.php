    ...
    <div class="w3-half">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <p><i class="fa fa-usd fa-fw w3-margin-right w3-large w3-text-teal"></i><?php print $usd ?></p>
          <p><i class="fa fa-eur fa-fw w3-margin-right w3-large w3-text-teal"></i><?php print $eur ?></p>
